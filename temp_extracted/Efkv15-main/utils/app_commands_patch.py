        ...
        def decorator(func):
            ...
            if hasattr(discord, 'option'):
                try:
                    ...
                    # First just add descriptions to function without modifying parameters
                    # This prevents messing with parameter types
                    for name, description in kwargs.items():
                        # Store descriptions as metadata on the function
                        if not hasattr(func, "__descriptions__"):
                            func.__descriptions__ = {}
                        func.__descriptions__[name] = description
