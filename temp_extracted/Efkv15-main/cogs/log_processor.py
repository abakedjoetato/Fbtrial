...
# Import discord directly for namespace resolution
import discord

# Import from our compatibility layer
from discord_compat_layer import (
    Embed, Color, commands, Interaction, app_commands, tasks,
    slash_command, SlashCommandGroup, Option, Member, Guild, AppCommandOptionType
)
