...
def check_admin_permission(ctx) -> bool:
...
def has_admin_permission():
    """Decorator to check if a user has admin permission
    
    Returns:
        A command check that validates admin permission
    """
    async def predicate(ctx):
        return check_admin_permission(ctx)
