...
class CSVProcessorCoordinator:
    ...
    def __init__(self, bot):
        ...
        self.event_processor = None  # Will be set by set_events_processor
        
    def set_events_processor(self, callback):
        """
        Set the callback function for processing events found in CSV files
        
        Args:
            callback: Function to call for each event, should take event data as parameter
        """
        self.event_processor = callback
