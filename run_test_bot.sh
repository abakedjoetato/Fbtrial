...
# This script uses a diagnostic bot to test Discord connectivity

# Print a welcome message
echo "============================="
echo "   Test Discord Bot Script   "
echo "============================="
echo ""
...
# Run the bot
echo "Starting test Discord bot..."
PYTHONPATH="." PYTHONIOENCODING=utf-8 $PYTHON_PATH test_bot.py